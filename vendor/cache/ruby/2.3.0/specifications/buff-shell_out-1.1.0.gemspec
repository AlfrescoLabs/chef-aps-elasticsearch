...
Gem::Specification.new do |s|
  ...
  s.homepage = "https://github.com/berkshelf/buff-shell_out".freeze
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<buff-ruby_engine>.freeze, ["~> 1.0"])
      s.add_development_dependency(%q<thor>.freeze, ["~> 0.19.1"])
      ...
      s.add_dependency(%q<buff-ruby_engine>.freeze, ["~> 1.0"])
